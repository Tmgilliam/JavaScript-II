...
let allCaps = runners.map(function (obj) {
    
    console.log(obj.first_name.toUpperCase())
...
const largeShirts = runners.filter(word => word.shirt_size === 'L');
...
// Problem 1
const largeDonations = runners.filter(word => word.shirt_donations > 90);
